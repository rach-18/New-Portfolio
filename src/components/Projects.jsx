                ...
                <div className="flex md:flex-wrap md:flex-row flex-col gap-10">
                    <div className="flex lg:flex-row flex-col lg:w-full md:w-[45%] w-full lg:mx-0 mx-auto items-center lg:gap-10 gap-5 bg-[#A8C090] lg:py-10 py-8 lg:px-12 px-6 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
                        <div className="lg:w-[40%] md:w-full sm:w-1/2 w-full">
                            <img className="" src="Movix-project.png" alt="Movix Logo" />
                        </div>
                        <div className="flex flex-col gap-5 w-full 2xl:text-xl xl:text-base text-xs">
                            ...
                            <div className="flex lg:flex-row flex-col lg:justify-start justify-between lg:items-center items-start gap-2">
                                <a href="https://github.com/rach-18/Movie-Application" target='_blank' className="bg-white p-2 rounded-lg font-semibold text-[#006837] hover:shadow-lg github-repo"><i className="fa-brands fa-github"></i> Github</a>
                                <a className="text-white" target='_blank' href="https://movie-application-liart.vercel.app/">Click here to visit the live project!</a>
                            </div>
                        </div>
                    </div>
                    <div className="flex lg:flex-row flex-col lg:w-full md:w-[45%] w-full lg:mx-0 mx-auto items-center lg:gap-10 gap-5 bg-[#A8C090] lg:py-10 py-8 lg:px-12 px-6 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
                        <div className="lg:w-[40%] md:w-full sm:w-1/2 w-full">
                            <img className="" src="Google-Drive-Clone-project.png" alt="Google Drive Logo" />
                        </div>
                        <div className="flex flex-col gap-5 w-full 2xl:text-xl xl:text-base text-xs">
                            ...
                            <div className="flex lg:flex-row flex-col lg:justify-start justify-between lg:items-center items-start gap-2">
                                <a href="https://github.com/rach-18/Google-Drive-Clone" target='_blank' className="bg-white p-2 rounded-lg font-semibold text-[#006837] hover:shadow-lg github-repo"><i className="fa-brands fa-github"></i> Github</a>
                                <a className="text-white" target='_blank' href="https://google-drive-clone-pink.vercel.app/">Click here to visit the live project!</a>
                            </div>
                        </div>
                    </div>
                    <div className="flex lg:flex-row flex-col lg:w-full md:w-[45%] w-full lg:mx-0 mx-auto items-center lg:gap-10 gap-5 bg-[#A8C090] lg:py-10 py-8 lg:px-12 px-6 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
                        ...
                        <div className="flex flex-col gap-5 w-full 2xl:text-xl xl:text-base text-xs">
                            ...
                            <div className="flex lg:flex-row flex-col lg:justify-start justify-between lg:items-center items-start gap-2">
                                ...
                                <a className="text-white" target='_blank' href="https://mct-u-matter.vercel.app/">Click here to visit the live project!</a>
                            </div>
                        </div>
                    </div>
                    <div className="flex lg:flex-row flex-col lg:w-full md:w-[45%] w-full lg:mx-0 mx-auto items-center lg:gap-10 gap-5 bg-[#A8C090] lg:py-10 py-8 lg:px-12 px-6 rounded-[2.5rem]" data-aos="zoom-in" data-aos-duration="1500">
