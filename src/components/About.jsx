...
function About() {
  ...
  const exp = [
    ...
    },
    {
      ...
      logo: "https://sagittariusinc.in/wp-content/uploads/2022/01/IEMLabs-LOGO_COLOR-TEXT-1.png",
    },
  ];
      ...
      <div className="flex lg:flex-row flex-col xl:gap-20 lg:gap-10 gap-2 mt-32 xl:mb-32 sm:mb-16 mb-12 w-5/6 mx-auto items-center justify-center overflow-x-hidden">
        ...
        >
          <p className="bg-[#A8C090] sm:p-10 p-6 rounded-2xl text-white 2xl:text-xl lg:text-lg text-sm">
            I graduated in 2023 with a degree in software engineering and have
            completed two internships focused on full-stack development.
            Passionate about coding and continuously learning new technologies,
            I am eager to start my professional career and contribute to
            impactful projects.
          </p>
          <div
            id="message-pointer"
